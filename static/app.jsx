                        ...
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-8">
                            <div className="bg-white border border-gray-200 rounded-xl p-4">
                                ...
                                <div className="text-2xl font-bold text-gray-900">
                                    {metrics.knowledge_bases_count ?? metrics.assistants_count ?? metrics.knowledge_bases ?? 0}
                                </div>
                            </div>
                            <div className="bg-white border border-gray-200 rounded-xl p-4">
                                <div className="text-xs uppercase text-gray-500">Documents</div>
                                <div className="text-2xl font-bold text-gray-900">
                                    {metrics.documents_count ?? metrics.documents ?? 0}
                                </div>
                            </div>
                            <div className="bg-white border border-gray-200 rounded-xl p-4">
                                <div className="text-xs uppercase text-gray-500">Users</div>
                                <div className="text-2xl font-bold text-gray-900">
                                    {metrics.total_users ?? metrics.users ?? 0}
                                </div>
                            </div>
                        </div>
                    )}
                    ...
                    {loading ? (
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                            {knowledgeBases.map((kb, idx) => {
                                const summarySource = metrics?.knowledge_bases || metrics?.assistants;
                                const summary = Array.isArray(summarySource) ? summarySource.find((a) => a.id === kb.id) : null;
                                return (
